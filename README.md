...
* Gradient colours for the Navigation and Footer menu are #ff6666 and #ffff8f.
...
* **Enquiry Form** - Allows the user to contact [Happy Hour](https://amiejohnstone18.github.io/Happy-Hour/index.html) by filling out the form, presented on the [index.html](https://amiejohnstone18.github.io/Happy-Hour/index.html) home page.
...
2. This will take you to a separate page that displays 20 different cocktails.
...
4.	Clicked Save
5.	The website link can be found at [https://amiejohnstone18.github.io/Happy-Hour/](https://amiejohnstone18.github.io/Happy-Hour/index.html)
6.	Ran the URL in a new browser window, left with a 404 server error
7.  Left the browser for a few minutes and refreshed the page, the website was then displayed.
...
I have received inspiration from this project due to the recent world pandemic and as a result, the lockdown that occurred for 4 months. During this time, individuals did not have access to pubs, restaurants or bars which meant they had to rely on themselves for entertainment. I myself found I was searching the web a lot for recipes, descriptions, reviews on food and drink I wouldn't necessarily make at home and required some guidance for. Because of this, when I was initially looking for [API's](https://en.wikipedia.org/wiki/Application_programming_interface) using [ProgrammableWeb](https://www.programmableweb.com/) and came across the food and beverages API's, I had decided this was quite a fitting idea for current circumstances. Although there was a lot of data to choose from, I decided to make the project more niche and solely focus on cocktails specifically. 

I would like to thank my mentor Aaron Sinnett for his brilliant help during this project. He was able to simplify areas of code and ensure that I was able to carry on effectively when times became difficult. 
